    ...
    public partial struct StatefulTriggerEventBufferSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            EntityQueryBuilder builder = new EntityQueryBuilder(Allocator.Temp)
                .WithAllRW<StatefulTriggerEvent, HasPhysicsEvents>()
        ...
        public partial struct ClearTriggerEventDynamicBufferJob : IJobEntity
        {
            ...
            public void Execute(ref DynamicBuffer<StatefulTriggerEvent> eventBuffer, EnabledRefRW<HasPhysicsEvents> hasEvents)
            {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var lookup = SystemAPI.GetComponentLookup<HasPhysicsEvents>();
